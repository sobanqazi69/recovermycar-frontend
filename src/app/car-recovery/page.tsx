...
export const metadata: Metadata = {
  title: `Cheap Car Recovery UK — All Areas | ${siteConfig.name}`,
  description: `Find cheap car recovery in your area. ${siteConfig.name} covers ${cities.length}+ UK cities — Birmingham, London, Manchester, Leeds & more. 24/7 breakdown recovery, instant fixed-price quotes.`,
  keywords: [
  ...
  openGraph: {
    title: `Cheap Car Recovery UK — All Areas | ${siteConfig.name}`,
    description: `${siteConfig.name} covers ${cities.length}+ UK cities. Cheap 24/7 breakdown recovery with instant online quotes.`,
